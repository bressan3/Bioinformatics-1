"""File containing the main function for assignemnt 1 for the Bioinformatics class.
...
def main():
    ...
    for aminoIndex in range(0, len(aminoAcidSeqList)):
        ...
        hydrophobic = TransmembraneFinder.mostHydrophobicRegion(
            aminoAcidSeqList[aminoIndex], bestWinSize)
    ...
    for index in range(0, len(testSeqList)):
        ...
        newSeq = TransmembraneFinder.findHydrophobicRegions(
            dictionaryList, amino)
